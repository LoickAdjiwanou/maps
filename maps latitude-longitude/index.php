    ...
    <div class="flex items-center flex-col space-y-20 justify-center h-screen bg-gray-200 sm:px-6">
        <div class="w-full max-w-sm p-4 bg-white rounded-md shadow-md sm:p-6">
            ...
            <form class="mt-4" method="POST" action="">
                ...
                <span class="text-base font-bold text-gray-700">Votre latitude:</span>
                ...
                <span class="text-base font-bold text-gray-700">Votre longitude:</span>
        ...
        ?>
        <iframe src="https://maps.google.com/maps?&q=<?php echo $latitude.','.$longitude; ?>&output=embed  " width="100%" height="500"></iframe>
        <?php } ?>
    </div>
